# 🌅 Complete 24-Hour Western Time Themes Reference

This file contains all 9 time-of-day themes for reference. The automation will cycle through these on your main README.
...
### Option 5A: Crescent Moon Only
![Midnight V5A](https://capsule-render.vercel.app/api?type=waving&color=0:1C1C1C,50:2F4F4F,100:696969&height=240&section=header&text=rundowntown%20🌙&fontSize=90&fontColor=DAA520&stroke=000000&strokeWidth=1&fontAlignY=38&desc=Stars%20Above.%20Silence%20Below.&descSize=28&descAlignY=58&animation=fadeIn)

### Option 5B: Full Moon
![Midnight V5B](https://capsule-render.vercel.app/api?type=waving&color=0:1C1C1C,50:2F4F4F,100:696969&height=240&section=header&text=rundowntown%20🌕&fontSize=90&fontColor=DAA520&stroke=000000&strokeWidth=1&fontAlignY=38&desc=Stars%20Above.%20Silence%20Below.&descSize=28&descAlignY=58&animation=fadeIn)
...
- **Sunrise**: Pink → Red → Gold
- **Morning**: Orange → Light Orange → Yellow  
- **Midday**: Gold → Bright Yellow → Yellow
- **Late Afternoon**: Dark Orange → Orange → Goldenrod
- **Evening/Sunset**: Red-Orange → Tomato → Light Salmon
- **Dusk**: Saddle Brown → Sienna → Burlywood
- **Midnight**: Very Dark → Dark Slate → Gray
- **Late Night**: Black → Midnight Blue → Dark Slate
- **Early Morning**: Midnight Blue → Dark Slate Blue → Slate Blue

---

**Note**: This reference file won't be displayed publicly. Your main README will only show ONE theme at a time, auto-updating every 2-3 hours based on UTC time!
